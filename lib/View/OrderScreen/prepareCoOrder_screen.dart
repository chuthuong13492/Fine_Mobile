...
class PrepareCoOrderScreen extends StatefulWidget {
  final OrderDTO? dto;
  const PrepareCoOrderScreen({super.key, required this.dto});

  @override
  State<PrepareCoOrderScreen> createState() => _PrepareCoOrderScreenState();
}

class _PrepareCoOrderScreenState extends State<PrepareCoOrderScreen> {
                    ...
                    builder: (context, child, model) {
                      return Column(
                        children: [
                          ...
                          Container(
                              child:
                                  layoutOrder(model.orderDTO!.orderDetails!)),
                          SizedBox(
                              height: 8,
                              child: Container(
                                color: FineTheme.palettes.primary50,
